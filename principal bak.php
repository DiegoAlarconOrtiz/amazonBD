                        ...
                        <tr>
                            <td class="align-items-center align-middle justify-content-center"
                                ...
                                <img style="max-width:100px; max-height:100px;" 
                                    src="./imagenes/<?php echo $fila["imagen"]?>">
                            </td>
                            <td class="fs-4 align-middle"><?php echo $fila["nombreProducto"]?></td>
                            <td class="display-6 align-middle"><?php echo $fila["precio"]?>€</td>
                            <td class="align-middle">
                                <form method="post">
                                    ...
                                    if (!isset($usuario)) { ?>
                                        ...
                                        <input type="hidden" name="anadir" value="<?php echo $fila["idProducto"]?>"><?php
                                    } ?>
                                    <button type="submit" class="btn btn-primary"
                                            style="max-width:70px; max-height:70px;">
                                        <img style="filter: invert(100%); max-width:50px; max-height:50px;" src="./imagenes/cesta.png" alt="">
                                    </button>
                                </form>
                            </td>
                        </tr>
